...
export const LLM_PROVIDER_MODELS = {
  ...
  "google": ["gemini-3.1-pro-preview", "gemini-3.1-flash-image-preview", "gemini-3.1-flash-lite-preview", "gemini-3-pro-preview", "gemini-3-pro-image-preview", "gemini-3-flash-preview", "gemini-2.5-pro", "gemini-2.5-flash", "gemini-2.5-flash-lite", "gemini-2.5-flash-lite-preview-06-17", "gemini-2.0-flash"],
...
export const LLM_MODEL_OPTIONS: Array<{
  ...
  {
    pattern: /^grok-(?:4\.20-reasoning|4(?:-1)?(?:-fast-reasoning)?|4(?:-latest|-0709)?|3(?:-mini)?(?:-latest)?|code-fast-1)$/,
