...
Target language: {{targetLanguage}}`,
  ...
  "deprecated-docs-driven-provider-models": {
    description: "v068 migrates removed docs-driven provider model ids into custom model entries",
    config: {
      language: {
        sourceCode: "jpn",
        targetCode: "eng",
      ...
      providersConfig: [
        ...
        },
        {
          ...
          model: {
            ...
            isCustomModel: true,
            customModel: "claude-3-5-haiku-latest",
          },
        },
        {
          id: "xai-default",
        ...
        },
        {
          ...
          model: {
            ...
            isCustomModel: true,
            customModel: "pixtral-large-latest",
          },
        },
      ],
      translate: {
